...
BASE_NAME="ngc_cganet_nodes_5_evonorm_lr_0.01_gamma_0.1_alpha_1.0_skew_1_ring"

# ============================================================
# NGC — Clean setting (uniform quality, no label noise)
# ============================================================
...
echo ""
echo "========== [NGC] Clean setting DONE =========="
echo ""

# ============================================================
# NGC — Noisy setting (tiered quality)
